...
-(void)setCurrentBluetoothListeningMode:(NSString *)listeningMode forAccessory:(EAAccessory *)accessory v2: (BOOL) v2 {
	...
	dispatch_async(queue, ^{
		...
		char command[] = {0x01, static_cast<char>(v2 ? 0x05 : 0x06), 0x02, static_cast<char>(v2 ? 0x02 : 0x01), static_cast<char>(isNC ? (v2 ? 0x00 : 0x01) : isOff ? (v2? 0x05 : 0x03) : (v2 ? 0x0a : 0x00)), static_cast<char>(v2 ? 0x01 : NULL)};
